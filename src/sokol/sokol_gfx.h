...
typedef enum sg_pixel_format {
    ...
    SG_PIXELFORMAT_RGB5A1,  // << added
    SG_PIXELFORMAT_RGBA4,   // << added
...
_SOKOL_PRIVATE GLenum _sg_gl_teximage_internal_format(sg_pixel_format fmt) {
    ...
    if (_sg.gl.gles2) {
        ...
        switch (fmt) {
            ...
            case SG_PIXELFORMAT_RGB5A1:     return GL_RGB5_A1;  // added
            case SG_PIXELFORMAT_RGBA4:      return GL_RGBA4;    // added
            #if !defined(SOKOL_GLES3)
...
_SOKOL_PRIVATE void _sg_gl_init_pixelformats(bool has_bgra) {
    ...
    if (!_sg.gl.gles2) {
        ...
        // new
        _sg_pixelformat_all(&_sg.formats[SG_PIXELFORMAT_RGB5A1]);
        _sg_pixelformat_all(&_sg.formats[SG_PIXELFORMAT_RGBA4]);
    }
    #endif
